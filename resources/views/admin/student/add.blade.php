                ...
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="form-group col-6">
                        ...
                        <input type="text" name="admission_number" required value="{{ old('admission_number') }}"  class="form-control rounded-0" id="exampleInputRounded0" placeholder=".rounded-0">
                        <div>{{ $errors->first('admission_number') }}</div>
                      </div>

                      <div class="form-group col-6">
                        <label for="exampleInputRounded0">Roll Number</label>
                        <input type="text" name="roll_number" value="{{ old('roll_number') }}"  class="form-control rounded-0" id="exampleInputRounded0" placeholder=".rounded-0">
